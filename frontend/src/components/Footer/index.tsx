      ...
      <div className={styles.links}>
        ...
        <div>
          ...
          <ul className={styles.socials}>
            ...
            <li>
              <Link href="https://www.instagram.com/artisanbarber/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link href="https://maps.app.goo.gl/SREW4q3vnPWLCmyr7" target="_blank" rel="noopener noreferrer" aria-label="Google">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link href="https://www.youtube.com/@ARTISANBARBER" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 24 24">
